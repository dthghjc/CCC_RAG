...
class Settings(BaseSettings):
    ...
    # FastAPI API
    FASTAPI_API_KEY: Optional[str] = os.getenv("FASTAPI_API_KEY", "sk-key")
    ...
    # Milvus
    MILVUS_SERVICE_URI: Optional[str] = os.getenv("MILVUS_SERVICE_URI")
    MILVUS_TOKEN_ROOT: Optional[str] = os.getenv("MILVUS_TOKEN_ROOT")
    MILVUS_TOKEN_USER: Optional[str] = os.getenv("MILVUS_TOKEN_USER")
    ...
    # MySQL
    MYSQL_HOST: Optional[str] = os.getenv("MYSQL_HOST", "db")
    MYSQL_PORT: int = int(os.getenv("MYSQL_PORT", 3306))
    MYSQL_USER: Optional[str] = os.getenv("MYSQL_USER", "dthghjc")
    MYSQL_PASSWORD: Optional[str] = os.getenv("MYSQL_PASSWORD", "24Khjcmysql")
    ...
    # JWT
    SECRET_KEY: Optional[str] = os.getenv("SECRET_KEY", "f7a8b9c0d1e2f3g4h5i6j7k8l9m0n1o2p3q4r5s6t7u8v9w0x1y2z3")
